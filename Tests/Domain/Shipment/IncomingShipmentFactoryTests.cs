...
{
    [TestClass]
    public class IncomingShipmentFactoryTests : ClassTest<IncomingShipmentFactory, object>
    {
        [TestMethod]
        public void Create()
        {
            //var testObject = GetRandom.Object(typeof(IncomingShipmentData));
            IncomingShipmentObject testObject = IncomingShipmentFactory.Create(
                GetRandom.String(),
                GetRandom.UInt32(),
                GetRandom.String(),
                GetRandom.UInt32(),
            ...
            Assert.AreEqual(testObject.GetType(), IncomingShipmentFactory.Create(
                GetRandom.String(),
                GetRandom.UInt32(),
                GetRandom.String(),
                GetRandom.UInt32(),
